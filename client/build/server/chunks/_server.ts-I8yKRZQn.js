...
//#region src/routes/api/bookmarks/+server.ts
...
var GET = async ({ fetch, request, url }) => {
	try {
		...
		const res = await fetch(`${BACKEND_URL}/api/bookmarks${url.search}`, { headers });
...
export { GET };
//# sourceMappingURL=_server.ts-I8yKRZQn.js.map
