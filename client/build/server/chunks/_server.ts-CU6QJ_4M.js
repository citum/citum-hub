...
//#region src/routes/api/hub/[styleKey]/download/+server.ts
...
var GET = async ({ params, fetch, request, url }) => {
	try {
		...
		const res = await fetch(`${BACKEND_URL}/api/hub/${encodeURIComponent(params.styleKey)}/download${url.search}`, { headers });
...
export { GET };
//# sourceMappingURL=_server.ts-CU6QJ_4M.js.map
