...
//#region src/routes/api/hub/[styleKey]/aliases/+server.ts
...
var GET = async ({ params, fetch, request, url }) => {
	try {
		...
		const res = await fetch(`${BACKEND_URL}/api/hub/${encodeURIComponent(params.styleKey)}/aliases${url.search}`, { headers });
...
export { GET };
//# sourceMappingURL=_server.ts-0Mnp4F_i.js.map
