...
<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
	<div class="flex flex-col lg:flex-row gap-10 min-h-[calc(100vh-12rem)] relative">
		...
		<aside
			class="w-full lg:w-[450px] flex flex-col bg-white border border-border-light rounded-2xl shadow-sm overflow-hidden sticky top-24 h-fit"
		>
			<div class="p-8">
				<!-- Breadcrumbs -->
				...
				<div class="flex flex-col gap-2 mb-8">
					...
					{#if saveMessage}
						<p class="text-[10px] font-bold uppercase tracking-widest text-green-600 mt-2">
							{saveMessage}
						</p>
					{/if}
		...
		<main
			class="flex-1 bg-white rounded-3xl border border-border-light shadow-sm p-4 lg:p-8 relative overflow-hidden flex flex-col items-center"
		>
			<div class="w-full max-w-[800px] flex flex-col gap-12">
				...
				<div class="mt-8 p-6 bg-blue-50/50 rounded-2xl border border-blue-100/50">
					<h4 class="text-xs font-black text-blue-900 uppercase tracking-widest mb-2">
						Technical Insight
					</h4>
					<p class="text-[11px] text-blue-800/70 leading-relaxed">
						...
						The formatting matches exactly what will appear in your document editor based on the
						current logic.
					</p>
				</div>
			</div>
